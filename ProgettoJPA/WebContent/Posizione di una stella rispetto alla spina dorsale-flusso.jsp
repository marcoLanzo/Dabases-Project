			...
			if (request.getParameter("Search") != null) {
				try {
					...
					allStars = scheletrobean.DistanzaSpina(allStars);
				  	allStars = stellabean.DistanzaSpinaOrderedBYFlusso(allStars);
					stellabean.setnStelleFlusso(allStars.size());
...
<h2>Posizione di una stella rispetto alla spina dorsale-flusso:</h2>
	<br><br>
	<hr>
<form action="Posizione di una stella rispetto alla spina dorsale-flusso.jsp" name="myform" method="POST" class="form-inline">
<br>
<strong>Ordina in base al flusso:</strong>
	<br><br>
...
<form action="Posizione di una stella rispetto alla spina dorsale-flusso.jsp" method="POST">			
				
				<div class="bs-example">
			 	<h1></h1>
			 	 	<h1></h1>					
				
				<% if (stellabean.getnStelleFlusso() > 0){
				...
				%>				
					    ...
					    <table class="table table-striped">
					        ...
					        <tbody>
					        	...
					        	for(int x=stellabean.getC()*20; x< Math.min(stellabean.getC()*20+20, stellabean.getnStelleFlusso()); x++){
									%>
					            <tr>
					                <td><%out.print(x+1);%></td>
							...
							<%if(stellabean.getC()==0 ){
								...
								<%} %>
								 ...
								 <%if(stellabean.getC()*20+20>stellabean.getnStelleFlusso() && stellabean.getC()>0 ){

							 	%>
								<button class="btn btn-link" name="indietro" id="indietro">indietro</button>
								<%}
								 if(stellabean.getC()>0 && !(stellabean.getC()*20+20>stellabean.getnStelleFlusso() && stellabean.getC()>0)){%>
